...
use App\Relatorio\RelTemplate;
use App\Relatorio\FPDF\FPDF;

//use Zend\ServiceManager\ServiceManager;

class Teste extends FPDF{

    protected $pdf;

    //function __construct(ServiceManager $service) {

    function __construct() {
        //$this->logger = $logger;
       
      //  $this->relTemplate = $service->get('Checkin\\Relatorio\\RelTemplate');
    }
